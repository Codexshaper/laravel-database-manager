...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ dbm_asset('vendor/linearicons/style.css') }}"> -->

    <!-- MAIN CSS -->
    <!-- <link rel="stylesheet" href="{{ dbm_asset('css/style.css') }}"> -->
    <link href="{{ dbm_asset('css/jquery.nestable.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ dbm_asset('css/new.css') }}">
...
<body>
    <div id="app">
        ...
        <div id="wrapper">
            <!-- MAIN -->
            <div class="col-md-8 offset-md-2 vue-content">
                <database-api prefix="{{ dbm_prefix() }}" driver="{{ dbm_driver() }}"></database-api>
            </div>
    ...
    <script src="{{ dbm_asset('vendor/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
